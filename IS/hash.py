...
try:
    ...
    fciv = Label(window,bg='yellow',fg='blue',text='File Validity',height=1,width=30,font="Times 16 bold italic").grid(row=1,column=0,columnspan=12)
    ...
    if(opened==1):
        saveButton = Button(window,text='Reset State',bg='skyblue',activebackground='lightgreen',relief=RAISED,font="Times 10 bold",command=reset).grid(row=9,column=5)
        message=Label(window,text='a state was saved earlier',bg='yellow',fg='red').grid(row=9,column=6)
    else:
        saveButton = Button(window,text='Save State',bg='skyblue',activebackground='lightgreen',relief=RAISED,command=saveState,font="Times 10 bold").grid(row=9,column=5)
    
    checkButton = Button(window,text='Check Integrity',bg='lightpink',activebackground='lightgreen',relief=RAISED,command=checkIntegrity,font="Times 10 bold").grid(row=7,column=5) 
except:
